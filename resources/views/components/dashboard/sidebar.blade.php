<style>
    ...
    .main-sidebar {
        background-color: #222d32 !important; /* Warna dasar sidebar */
    }

    /* Styling Menu Item */
    .sidebar-menu > li {
        margin: 4px 12px; /* Memberi ruang agar terlihat melayang/rounded */
        transition: all 0.3s;
    }
    ...
    .sidebar-menu > li > a {
        ...
        border-left: none !important; /* Menghilangkan border kiri default AdminLTE */
    }
    ...
    .sidebar-menu > li.menu-open > a {
        ...
        box-shadow: 0 4px 10px rgba(0, 166, 90, 0.3); /* Shadow halus */
    }
    ...
    .sidebar-menu .treeview-menu > li.active > a {
        color: #00a65a !important; /* Text hijau untuk sub-menu aktif */
        font-weight: bold;
    ...
    <section class="sidebar">
        <ul class="sidebar-menu" data-widget="tree">
            ...
            @if (Auth::user()->role === 'admin')
                ...
                <li class="treeview {{ request()->routeIs('admin.tahun-ajaran.*', 'admin.gelombang.*', 'admin.unit.*', 'admin.sekolah-pilihan.*') ? 'active menu-open' : '' }}">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ request()->routeIs('admin.tahun-ajaran.*') ? 'active' : '' }}">
                            <a href="{{ route('admin.tahun-ajaran.index') }}" class="btn-loading"><i class="fa fa-circle-o"></i> Tahun Ajaran</a>
                        </li>
                        <li class="{{ request()->routeIs('admin.gelombang.*') ? 'active' : '' }}">
                            <a href="{{ route('admin.gelombang.index') }}" class="btn-loading"><i class="fa fa-circle-o"></i> Gelombang</a>
                        </li>
                        <li class="{{ request()->routeIs('admin.unit.*') ? 'active' : '' }}">
                            <a href="{{ route('admin.unit.index') }}" class="btn-loading"><i class="fa fa-circle-o"></i> Unit</a>
                        </li>
                        <li class="{{ request()->routeIs('admin.sekolah-pilihan.*') ? 'active' : '' }}">
                            <a href="{{ route('admin.sekolah-pilihan.index') }}" class="btn-loading"><i class="fa fa-circle-o"></i> Sekolah Pilihan</a>
                        </li>
                    </ul>
                </li>

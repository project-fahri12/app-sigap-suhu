    ...
    <div class="ppdb-container text-start">
        ...
        <ul class="nav nav-tabs" id="pendaftaranTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link active" id="peserta-tab" data-bs-toggle="tab" data-bs-target="#peserta-pane"
                    type="button" role="tab" aria-controls="peserta-pane" aria-selected="true">
                    <i class="fa fa-user me-2"></i> Data Calon Peserta
                </button>
            </li>
            {{-- Tab 2: Data Orang Tua / Wali --}}
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="ortu-tab" data-bs-toggle="tab" data-bs-target="#ortu-pane" type="button"
                    role="tab" aria-controls="ortu-pane" aria-selected="false">
                ...
                <div class="tab-pane fade show active" id="peserta-pane" role="tabpanel" aria-labelledby="peserta-tab"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $tahun_ajaran->tahun }}" readonly>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $gelombang->nama_gelombang }}" readonly>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="sekolah_pilihan_id" class="form-label">Pilihan Sekolah <span
                        ...
                        {{-- Status Santri --}}
                        <div class="col-md-6 mb-3">
                            <label for="status_santri" class="form-label">
                                Status Santri <span class="text-danger">*</span>
                            </label>
                            <select name="status_santri" id="status_santri" class="form-control" required>
                                ...
                                <option value="mukim" {{ old('status_santri') == 'mukim' ? 'selected' : '' }}>
                                    Mukim (Tinggal di Pondok)
                                </option>
                                <option value="non_mukim" {{ old('status_santri') == 'non_mukim' ? 'selected' : '' }}>
                        ...
                        {{-- 5. NIK (pendaftar.nik) --}}
                        <div class="col-md-4 mb-3">
                            <label for="nik" class="form-label">NIK Calon Peserta <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('nik') is-invalid @enderror" id="nik"
                                name="nik" placeholder="Nomor Induk Kependudukan (16 Digit)" required
                                value="{{ old('nik') }}">
                            @error('nik')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control @error('asal_sekolah') is-invalid @enderror"
                                id="asal_sekolah" name="asal_sekolah" placeholder="Asal Sekolah"
                        ...
                        <div class="col-md-5 mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_lengkap') is-invalid @enderror"
                                id="nama_lengkap" name="nama_lengkap" placeholder="Nama lengkap sesuai KK/Ijazah"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control @error('tempat_lahir') is-invalid @enderror"
                                id="tempat_lahir" name="tempat_lahir" placeholder="Contoh: Jombang" required
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="alamat" class="form-label">Alamat Lengkap (Tempat Tinggal Santri) <span
                                    class="text-danger">*</span></label>
                            <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" rows="3"
                                placeholder="Alamat lengkap, RT/RW, Desa/Kel, Kec, Kab/Kota" required>{{ old('alamat') }}</textarea>
                            @error('alamat')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex justify-content-end mt-4">
                            <button type="button" class="btn btn-ppdb"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="tel" class="form-control @error('no_hp_ayah') is-invalid @enderror"
                                id="no_hp_ayah" name="no_hp_ayah" placeholder="08xxxxxxxxx"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('status_ayah') is-invalid @enderror" id="status_ayah"
                                ...
                                <option value="tidak_diketahui"
                                    {{ old('status_ayah') == 'tidak_diketahui' ? 'selected' : '' }}>Tidak Diketahui
                                </option>
                            </select>
                            @error('status_ayah')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('pekerjaan_ibu') is-invalid @enderror"
                                id="pekerjaan_ibu" name="pekerjaan_ibu" placeholder="Contoh: Ibu Rumah Tangga/PNS"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="tel" class="form-control @error('no_hp_ibu') is-invalid @enderror"
                                id="no_hp_ibu" name="no_hp_ibu" placeholder="08xxxxxxxxx"
                                value="{{ old('no_hp_ibu') }}">
                            @error('no_hp_ibu')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('status_ibu') is-invalid @enderror" id="status_ibu"
                                ...
                                <option value="meninggal" {{ old('status_ibu') == 'meninggal' ? 'selected' : '' }}>
                                    Meninggal</option>
                                <option value="tidak_diketahui"
                                    {{ old('status_ibu') == 'tidak_diketahui' ? 'selected' : '' }}>Tidak Diketahui</option>
                            </select>
                            @error('status_ibu')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control @error('alamat_orang_tua') is-invalid @enderror" id="alamat_orang_tua"
                                name="alamat_orang_tua" rows="3" placeholder="Alamat lengkap Orang Tua sesuai KK">{{ old('alamat_orang_tua') }}</textarea>
                        ...
                        <h6 class="mt-4 mb-3 pb-1 border-bottom" style="color: var(--sigap-blue);"><i
                                class="fa fa-child me-1"></i> Data Wali Santri (Opsional)</h6>

                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <ul class="list-unstyled">
                                ...
                                <li><i class="fa fa-credit-card text-blue"></i> Pembayaran</li>
                                <li><i class="fa fa-upload text-orange"></i> Upload berkas</li>
                                <li><i class="fa fa-clock-o text-muted"></i> Verifikasi panitia</li>
                            </ul>
                            <hr> <a href="#" class="btn btn-success btn-block"> <i class="fa fa-whatsapp"></i> Gabung
                                Grup Informasi </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="box-body">
                            ...
                            @else
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <th>Tanggal Bayar</th>
                                        <td>{{ \Carbon\Carbon::parse($pembayaran->tanggal_bayar)->translatedFormat('d F Y') }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Status</th>
